...
export default function BookSinglePage() {
    ...
    if (!currentBook) {
        return <div className="text-red-400 text-center font-poppins pt-10">Kitob malumotlari topilmadi.</div>;
    }
    return (
            ...
            <div className="flex gap-[40px]">
                <div
                    ...
                    <div className="flex gap-[20px]">
                        <Image
                            src={currentBook?.image || "/book-image.svg"}
                            alt="book Image"
                            width={192}
                            height={272}
                        ...
                        <div className="w-full flex flex-col gap-[20px]">
                            ...
                            <div className="w-[292px] h-[30px] flex items-center">
                                <Image src="/pul.svg" alt="pul svg" width={28} height={28}
                            ...
                            <div className="w-[748px] h-[62px] flex">
                                <div
                                    ...
                                    <div className="w-[88px] h-[38px]">
                                        <div className="flex items-center gap-[5px]">
                                            <Image src="/star 1.svg" alt="daraja icon" width={14} height={14}
                                ...
                                <div
                                    ...
                                    <div className="w-[97px] h-[38px]">
                                        <div className="flex items-center gap-[5px]">
                                            <Image src="/icons.svg" alt="sahifa icon" width={14} height={14}
                                                   className="w-[14px] h-[14px]"/>
                                ...
                                <div
                                    ...
                                    <div className="w-[150px] h-[38px]">
                                        <div className="flex items-center gap-[5px]">
                                            <Image src="/category.svg" alt="kalendar icon" width={14} height={14}
                                                   className="w-[14px] h-[14px]"/>
                            ...
                            <div className="w-[370px] h-[50px] flex justify-between">
                                <button
                                    ...
                                    <Image src="/savat.svg" alt="savatcha" width={20} height={20}/>
                                    Savatchaga
                                </button>
